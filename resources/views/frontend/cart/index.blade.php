                                ...
                                <tbody class="my-auto">
                                    ...
                                    <tr class="cartpage">
                                        ...
                                        <td class="cart-product-sub-total">
                                            <span class="cart-sub-total-price">{{ number_format($data['item_price'], 2)
                                                }}</span>
                                        </td>
                                        ...
                                        <td class="cart-product-grand-total">
                                            <span class="cart-grand-total-price">{{ number_format($data['item_quantity']
                                                * $data['item_price'], 2) }}</span>
                                        </td>
                                        <td style="font-size: 20px;">
                                            <button type="button"
                                                class="badge badge-pill badge-danger delete_cart_data">
                        ...
                        <div class="col-md-4 col-sm-12 ">
                            <div class="cart-shopping-total">
                                <div style="padding-top:20px" class="row">
                                    <div class="col-md-6">
                                        <h6 class="cart-subtotal-name">Grandtotal</h6>
                                    </div>
                                    <div class="col-md-6">
                                        <h6 class="cart-subtotal-price">
                                            Rs.
                                            <span class="cart-grand-price-viewajax">{{ number_format($total, 2)
                                                }}</span>
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="cart-checkout-btn text-center">
                                            ...
                                            @endif
                                            <h6 class="mt-3">Checkout with Jaycart</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
