                    ...
                    <table class="table table-striped table-bordered" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('uploads/products/'.$product_item->image) }}" class="w-100"
                                        height="200px" alt="">
                                </td>
                                <td>

                                    <a href="{{url('details/'.$product_item->url)}}" class="text-center">
                                ...
                                <td>
                                    <h6 class="font-italic text-dark badge badge-warning px-3 py-1">{{
                                        $product_item->sale_tag }}</h6>
                                    <h6 class="font-italic orig_price"><s> Rs: {{
                                            number_format($product_item->original_price) }} </s></h6>
                                    <h5 class="font-italic font-weight-bold">Rs: {{
                                        number_format($product_item->offer_price) }}</h5>

                                    <div class="text-right">
                                        <div>
                                            <a href="{{url('details/'.$product_item->url)}}"
