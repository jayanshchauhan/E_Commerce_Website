      ...
      <nav style="color:black" class="navbar navbar-expand-lg ">
        ...
        <div class="container">
          ...
          <ul class="navbar-nav ml-auto ">
            ...
            <li class="nav-item"><a style="color:black" class="nav-link" href="{{ route('register') }}">Register</a>
            </li>
            @else
            <li class="nav-item dropdown">
              <a style="color:black" id="navbarDropdown" href="#"
                class="nav-link border border-light rounded waves-effect dropdown-toggle" data-toggle="dropdown"
...
<div class="row">
  <div class="col-md-12 py-2 bg-info shadow">
    ...
    @php
    $group = App\Models\Groups::where('status', '!=', notShow)->get();
    @endphp
